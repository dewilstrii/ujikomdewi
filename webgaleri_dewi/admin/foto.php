          ...
          <table class="table">
            ...
            <?php
              ...
              <tr>
                ...
                <td>
                   <button type="submit" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['fotoid'] ?>"> Edit
                </button>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="submit" name="edit" class="btn btn-danger">Edit data</button>
                            </form>
                        </div>
                    </div>
                </div>
              ...
              <button type="button" class="btn btn-danger mt-2" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['fotoid']; ?>"> Delete</button>
                  ...
                  <div class="modal fade" id="hapus<?php echo $data['fotoid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="submit" name="hapus" class="btn btn-primary" data-bs-dismiss="modal">Hapus data</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
 <p>&copy; UKK RPL 2024 | Dewi Lestari</p>
</footer>
